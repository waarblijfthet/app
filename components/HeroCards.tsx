...
const cardStyle: React.CSSProperties = {
  ...
  boxShadow: "0 4px 24px rgba(22, 33, 31,0.08), 0 1px 4px rgba(22, 33, 31,0.04)",
};
    ...
    <div className="hidden lg:block">
      <div className="relative w-full h-[520px]">
        ...
        >
          ...
          <p className="font-body text-xs mb-4" style={{ color: "#8B958F" }}>per maand over</p>
          <div className="space-y-2 mb-4">
            ...
            <div>
              ...
              <Bar pct={12} color="rgba(22, 33, 31,0.25)" />
            </div>
          </div>
        ...
        >
          ...
          <p className="font-body text-xs mb-4" style={{ color: "#8B958F" }}>per maand meer in dit voorbeeld</p>
          <span
            className="inline-block text-xs font-body font-medium px-3 py-1 rounded-full"
            style={{ backgroundColor: "#D4EDE0", color: "#16211F" }}
          >
