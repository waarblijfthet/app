...
export default function Stap6Resultaat({ data, onChange }: Props) {
  ...
  const bovenBenchmark = gesorteerd.filter((a) => a.diff > 50);

  function zinVoor(a: AfwijkingEntry, i: number): string {
    if (a.diff > 0) {
      return i === 0
        ? "Hier zit het grootste verschil in."
        : `Ook ${a.label.toLowerCase()} ligt hoger dan verwacht.`;
    }
    return `${a.label} ligt juist lager dan bij vergelijkbare huishoudens.`;
  }
    ...
    <div className="max-w-2xl mx-auto">
          ...
          <p className="font-body font-light text-text-soft text-sm leading-relaxed">
            {over >= spaardoelWaarde
              ...
              : `Je wilt ${fmtEur(
                ...
                )} meer dan de ruimte die we nu zien.`}
          </p>
        </div>
      )}
      ...
      <div className="rounded-xl border border-[#E6E9E7] bg-card p-6 mb-8">
        <p className="font-display font-light text-primary text-xl sm:text-2xl mb-1 leading-snug">
          Je weet nu wáár het verschil zit.
        </p>
        ...
        <p className="text-text-soft font-body font-light text-sm mb-3 leading-relaxed">
          Hoge boodschappen kunnen een probleem zijn. Maar net zo goed het gevolg
          van een groot gezin, bewuste keuzes of een patroon dat verder prima
          past.
        </p>
        <p className="text-text-soft font-body font-light text-sm mb-5 leading-relaxed">
          Daarom kijk ik bij de Geldscan persoonlijk naar het waarom, en wat ik
      ...
      {!sent ? (
        <div className="rounded-xl border border-[#E6E9E7] p-6">
          ...
          <p className="text-text-muted font-body font-light text-sm mb-5">
            Dan stuur ik hem naar je e-mail. Je resultaat blijft ook hierboven
            zichtbaar.
          </p>
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="font-body text-sm text-text-soft">
                Ik ga akkoord dat mijn antwoorden worden bewaard om deze uitkomst
                te kunnen mailen.
              </span>
            </label>
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              />
              <span className="font-body text-sm text-text-soft">
                Stuur me af en toe iets nuttigs van Waar blijft het (optioneel).
              </span>
            </label>
