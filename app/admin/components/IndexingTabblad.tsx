        ...
        <div className={`rounded-lg border text-sm ${resultaatKleur}`}>
          ...
          {debugUitgeklapt && resultaat.debug && (
            <div className="border-t border-current/20 px-4 py-3 space-y-1 font-mono text-xs">
              <div><strong>siteUrl:</strong> {resultaat.debug.siteUrl ?? "geen"}</div>
              <div><strong>tokenAccount:</strong> {resultaat.debug.tokenAccount ?? "geen"}</div>
              <div><strong>urlsChecked:</strong> {resultaat.debug.urlsChecked ?? "geen"}</div>
            </div>
          )}
              ...
              {rows.map((row, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-[#4A5A56]">{row.verdict ?? "geen"}</td>
