...
export default function AdminLoading() {
  return (
    <div className="min-h-screen bg-background">
      <div className="h-14 border-b border-[#E6E9E7] bg-white" />
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex gap-6 border-b border-[#E6E9E7] mb-7">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="h-4 w-20 mb-3 rounded bg-[#E6E9E7] animate-pulse" />
          ))}
        </div>
