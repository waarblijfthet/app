...
const spaken: { slug: string; tekst: string }[] = [
  ...
  { slug: "wat-kost-een-kind-per-maand", tekst: "Wat kost een kind per maand, en wat doet een tweede kind met jullie maand?" },
  { slug: "wat-kost-een-dag-minder-werken", tekst: "Wat kost een dag minder werken voor je hele huishouden?" },
  { slug: "hogere-hypotheek-wat-kost-het-per-maand", tekst: "Kunnen we dit huis betalen? Wat een hogere hypotheek met jullie maand doet" },
  { slug: "kind-wordt-18-wat-verandert-er-financieel", tekst: "Je kind wordt 18: wat verandert er financieel?" },
