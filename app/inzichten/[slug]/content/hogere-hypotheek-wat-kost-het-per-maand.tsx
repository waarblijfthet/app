  ...
  return (
    <>
      ...
      <p className="font-body text-text-soft" style={p}>
        ...
        <Link href="/inzichten/goed-salaris-toch-krap" style={{ color: "#C4603A", textDecoration: "none" }} className="hover:underline">goed salaris, toch krap</Link>: een hoge vaste last laat geen lucht over.
      </p>
      <p className="font-body text-text-soft" style={p}>
        Wil je zien hoeveel ruimte jullie woonlasten nu laten?{" "}
        <Link href="/analyse" style={{ color: "#C4603A", textDecoration: "none" }} className="hover:underline">Doe de gratis analyse</Link>{" "}— wonen is de eerste categorie die we vergelijken.
      </p>
    </>
  );
}
