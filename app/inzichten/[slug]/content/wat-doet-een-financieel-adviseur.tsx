  ...
  return (
    <div className="rounded-xl border my-8" style={{ backgroundColor: "#FDFAF4", borderColor: "#E8E0D4" }}>
      <div className="px-5 py-4 border-b" style={{ borderColor: "#E8E0D4" }}>
        <p className="font-body font-semibold text-sm" style={{ color: "#1C3A2A" }}>Heb jij een financieel adviseur nodig?</p>
        <p className="font-body text-xs mt-0.5" style={{ color: "#8A9E8E" }}>Drie vragen, direct antwoord</p>
      </div>
      <div className="p-5 space-y-5">
        {vragen.map((v, qi) => (
          <div key={qi}>
            <p className="font-body text-sm font-medium mb-2.5" style={{ color: "#1C3A2A" }}>{v.tekst}</p>
              ...
              {v.opties.map((opt, oi) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      border: `1.5px solid ${geselecteerd ? "#1C3A2A" : "#D6CEBC"}`,
                      backgroundColor: geselecteerd ? "#E8F2EC" : "white",
                      color: geselecteerd ? "#1C3A2A" : "#4A5E4E",
        ...
        {klaar && score !== null && (
          <div className="rounded-xl p-4 mt-2" style={{
            backgroundColor: score >= 3 ? "#E8F2EC" : "#E8F2EC",
            border: `1.5px solid ${score >= 3 ? "#A8C5B4" : "#A8C5B4"}`,
          }}>
            {score >= 3 ? (
              <>
                <p className="font-body font-semibold text-sm mb-1" style={{ color: "#1C3A2A" }}>Je hebt waarschijnlijk een gecertificeerde adviseur nodig.</p>
                <p className="font-body text-sm" style={{ color: "#2D4A35" }}>
                  ...
                  <a href="https://www.independer.nl" target="_blank" rel="noopener noreferrer" style={{ color: "#C4603A" }}>Independer</a>.
                </p>
              </>
            ) : (
              <>
                <p className="font-body font-semibold text-sm mb-1" style={{ color: "#1C3A2A" }}>Een eenmalig gesprek is voor jou waarschijnlijk genoeg.</p>
                <p className="font-body text-sm" style={{ color: "#2D4A35" }}>
  ...
  return (
    <div className="font-body text-text-soft" style={{ lineHeight: 1.75 }}>
      ...
      <p style={p}>
        ...
        <a href="https://www.afm.nl/nl-nl/consumenten/diensten-producten/financieel-advies/adviseurs-vergelijken" target="_blank" rel="noopener noreferrer" style={{ color: "#C4603A" }} className="hover:underline">AFM-register</a>.
      </p>
      <p style={p}>
      ...
      <p style={p}>
        ...
        <Link href="/adviesgesprek" style={{ color: "#C4603A", textDecoration: "none" }} className="hover:underline">eenmalig adviesgesprek</Link>, daarna, als dat nodig blijkt, een gecertificeerde adviseur voor een specifiek product.
      </p>
      <p style={p}>
