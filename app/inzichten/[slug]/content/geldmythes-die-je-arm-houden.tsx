  ...
  return (
    <>
      ...
      <p className="font-body text-text-soft" style={p}>
        ...
        <Link href="/inzichten/vergelijken-boodschappen-nederland-duitsland" style={{ color: "#C4603A", textDecoration: "none" }} className="hover:underline">boodschappen Nederland vs. Duitsland</Link>.
      </p>
