  ...
  return (
    <>
      ...
      <p className="font-body text-text-soft" style={p}>
        ...
        schoolvoorbeeld van{" "}
        <Link href="/inzichten/lifestyle-inflatie-meer-verdienen-meer-uitgeven" style={{ color: "#0B7A6E", textDecoration: "none" }} className="hover:underline">lifestyle-inflatie</Link>. Het geld verdwijnt niet in één post, maar in tientallen comfortabele keuzes.
      </p>
