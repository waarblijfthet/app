  ...
  return (
    <>
      ...
      <p className="font-body text-text-soft" style={p}>
        ...
        <Link href="/inzichten/seizoens-kostenkalender-per-maand" style={{ color: "#0B7A6E", textDecoration: "none" }} className="hover:underline">seizoens-kostenkalender</Link>. Hoe je met aparte potjes werkt, lees je in de{" "}
      ...
      <p className="font-body text-text-soft" style={p}>
        ...
        <a href="/inzichten/ons-boodschappenbudget-mislukte-tot-we-dit-deden" style={{ color: "#0B7A6E", textDecoration: "none" }} className="hover:underline">Ons boodschappenbudget mislukte, tot we dit deden</a>{" "}&middot;{" "}
        <a href="/inzichten/bso-kosten-tweede-inkomen-zo-draaiden-we-het-om" style={{ color: "#0B7A6E", textDecoration: "none" }} className="hover:underline">De BSO slokte ons tweede inkomen op</a>.
      </p>
    </>
  );
}
