...
export async function POST(request: NextRequest) {
  try {
    ...
    const html =
      ...
      hefbomenHtml +
      `<p style="margin:18px 0 18px 0;">Wil je weten hoe je op álle posten vergelijkt met huishoudens zoals dat van jou? Doe de analyse (5 minuten, anoniem, resultaat direct op je scherm): <a href="https://www.waarblijfthet.nl/analyse" style="color:#0B7A6E;">waarblijfthet.nl/analyse</a></p>` +
