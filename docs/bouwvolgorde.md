...
## 32. Plan ranken op de coachtermen, 25 september 2026

Op verzoek van Jarno, na sectie 30 en 31. Volledig plan: `docs/plan-coach-termen-ranken-25-sep-2026.md`. Nog niets gebouwd.

- Wat rankt (budget-kompas, simpelbudgetcoaching, budgethulpnederland) is niet langer of beter onderbouwd dan onze pagina's; het zet de zoekterm letterlijk in titel en H1 en geeft bij kosten prijzen per pakket.
- Onze pagina's praten om de term heen (N4), spreken hem tegen (verschil-artikel: "budgetcoach helpt bij schulden") of missen hem in titel en H1 (wat-kost, `/financieel-coach`).
