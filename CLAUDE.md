...
- SE Ranking connector was opnieuw niet geautoriseerd (OAuth vereist interactieve sessie); volumes blijven kwalitatief. Geen sitecode gewijzigd deze sessie, alleen docs + CLAUDE.md.
